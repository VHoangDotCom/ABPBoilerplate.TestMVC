...
{
    public abstract class CompanyManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CompanyManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CompanyManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CompanyManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CompanyManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CompanyManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CompanyManagementDbContext, Task<T>> func)
        {
            T result;
