...
using CompanyManagement.Web.Models.Account;
using CompanyManagement.Web.Views.Shared.Components.TenantChange;

namespace CompanyManagement.Web.Controllers
{
    public class AccountController : CompanyManagementControllerBase
    {
